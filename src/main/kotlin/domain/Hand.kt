...
val Card.pockets0:Sequence<Hand> get() = sequenceOf(Hand(card = this))
val Card.pockets1:Sequence<Hand> get() = pockets0.flatMap { it.filterChildren }

val Card.hands0:Sequence<Hand> get() = sequenceOf(Hand(card = this))
